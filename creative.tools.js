...
$.isImage = function(string) {
	...
	if(null === string || false === string)
		return false;
	return ((string.match(new RegExp('\\.(jpeg|jpg|gif|png|bmp|svg|tiff|jfif|exif|ppm|pgm|pbm|pnm|webp|hdr|hif|bpg|img|pam|tga|psd|psp|xcf|cpt|vicar)'))!=null) ? true : false);
};
/*
...
$.isVideo = function(string) {
	...
	return ((string.match(new RegExp('\\.(webm|mkv|flv|vob|ogv|ogg|drc|gifv|mng|avi|mov|qt|wmv|yuv|rm(vb)?|mp[42evg]|mpeg|m4p|3g[p2]|f4[vapb]|asf)'))!=null) ? true : false);
};
/*
